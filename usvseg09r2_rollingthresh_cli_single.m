function usvseg09r2_rollingthresh_cli_single(audio_filepath, params_filepath, output_filepath)
% 
% usvseg09r2_rollingthresh_cli_single
% Command line version of usvseg Long File with rolling percentile threshold value
% 231007
%
...
% % draw flattend spectrogram
% global gv;  
% fvec = gv.dat.fvec;
% tvec = gv.dat.tvec;
% % draw
% figure;
% imagesc(tvec,fvec/1000,mtsp); axis xy
% caxis([-130, -50]);
% 
% % average amplitude
% amplitude = sum(fltnd, 1);
% figure;
% plot(tvec, amplitude);
